...
final readonly class BadGateway extends Result implements CreateFromMessageAndDataContract, CreateFromMessageContract
{
    ...
    public static function from(string|null $message = null, array $data = []): Result
    {
        return self::create(
            false,
            $message ?? HttpResponseStatusCode::BadGateway->message(),
            HttpResponseStatusCode::BadGateway->value,
            $data
        );
    }
}
