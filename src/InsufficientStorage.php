...
final readonly class InsufficientStorage extends Result implements CreateFromMessageContract, CreateFromMessageAndDataContract
{
    ...
    public static function from(string|null $message = null, array $data = []): Result
    {
        return self::create(
            false,
            $message ?? HttpResponseStatusCode::InsufficientStorage->message(),
            HttpResponseStatusCode::InsufficientStorage->value,
            $data
        );
    }
}
