...
final readonly class MovedPermanently extends Result implements CreateFromMessageContract, CreateFromMessageAndDataContract
{
    ...
    public static function from(string|null $message = null, array $data = []): Result
    {
        return self::create(
            true,
            $message ?? HttpResponseStatusCode::MovedPermanently->message(),
            HttpResponseStatusCode::MovedPermanently->value,
            $data
        );
    }
}
