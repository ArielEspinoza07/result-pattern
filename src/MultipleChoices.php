...
final readonly class MultipleChoices extends Result implements CreateFromMessageContract, CreateFromMessageAndDataContract
{
    ...
    public static function from(string|null $message = null, array $data = []): Result
    {
        return self::create(
            true,
            $message ?? HttpResponseStatusCode::MultipleChoices->message(),
            HttpResponseStatusCode::MultipleChoices->value,
            $data
        );
    }
}
