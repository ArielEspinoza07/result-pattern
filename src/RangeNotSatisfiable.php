...
final readonly class RangeNotSatisfiable extends Result implements CreateFromMessageContract
{
    ...
    public static function from(string|null $message = null, array $data = []): Result
    {
        return self::create(
            false,
            $message ?? HttpResponseStatusCode::RangeNotSatisfiable->message(),
            HttpResponseStatusCode::RangeNotSatisfiable->value,
            $data
        );
    }
}
