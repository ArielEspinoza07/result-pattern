...
final readonly class RequestHeaderFieldsTooLarge extends Result implements CreateFromMessageContract
{
    ...
    public static function from(?string $message = null, array $data = []): Result
    {
        return self::create(
            false,
            $message ?? HttpResponseStatusCode::RequestHeaderFieldsTooLarge->message(),
            HttpResponseStatusCode::RequestHeaderFieldsTooLarge->value,
            $data,
        );
    }
}
