...
final readonly class ServiceUnavailable extends Result implements CreateFromMessageAndDataContract, CreateFromMessageContract
{
    ...
    public static function from(?string $message = null, array $data = []): Result
    {
        return self::create(
            false,
            $message ?? HttpResponseStatusCode::ServiceUnavailable->message(),
            HttpResponseStatusCode::ServiceUnavailable->value,
            $data,
        );
    }
}
