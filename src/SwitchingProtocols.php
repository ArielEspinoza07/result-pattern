...
final readonly class SwitchingProtocols extends Result implements CreateFromMessageContract
{
    ...
    public static function from(?string $message = null, array $data = []): Result
    {
        return self::create(
            true,
            $message ?? HttpResponseStatusCode::SwitchingProtocols->message(),
            HttpResponseStatusCode::SwitchingProtocols->value,
            $data,
        );
    }
}
