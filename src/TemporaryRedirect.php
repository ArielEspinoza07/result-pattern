...
final readonly class TemporaryRedirect extends Result implements CreateFromMessageAndDataContract, CreateFromMessageContract
{
    ...
    public static function from(?string $message = null, array $data = []): Result
    {
        return self::create(
            true,
            $message ?? HttpResponseStatusCode::TemporaryRedirect->message(),
            HttpResponseStatusCode::TemporaryRedirect->value,
            $data,
        );
    }
}
