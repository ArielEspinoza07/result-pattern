...
final readonly class UnavailableForLegalReasons extends Result implements CreateFromMessageContract, CreateFromMessageAndDataContract
{
    ...
    public static function from(string|null $message = null, array $data = []): Result
    {
        return self::create(
            false,
            $message ?? HttpResponseStatusCode::UnavailableForLegalReasons->message(),
            HttpResponseStatusCode::UnavailableForLegalReasons->value,
            $data
        );
    }
}
