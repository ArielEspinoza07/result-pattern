...
final readonly class UnsupportedMediaType extends Result implements CreateFromMessageAndDataContract, CreateFromMessageContract
{
    ...
    public static function from(string|null $message = null, array $data = []): Result
    {
        return self::create(
            false,
            $message ?? HttpResponseStatusCode::UnsupportedMediaType->message(),
            HttpResponseStatusCode::UnsupportedMediaType->value,
            $data
        );
    }
}
